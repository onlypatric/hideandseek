...
import com.patric.mcexp.hideseek.game.events.Border;
import com.patric.mcexp.hideseek.util.Location;
import com.patric.mcexp.hideseek.world.WorldLoader;
import org.bukkit.*;
...
public class Map {
    ...
    private com.patric.mcexp.hideseek.util.Location
        spawnPosition = com.patric.mcexp.hideseek.util.Location.getDefault(),
        lobbyPosition = com.patric.mcexp.hideseek.util.Location.getDefault(),
        seekerLobbyPosition = com.patric.mcexp.hideseek.util.Location.getDefault();
    ...
    public void setSpawn(com.patric.mcexp.hideseek.util.Location pos) {
        this.spawnPosition = pos;
    }

    public void setLobby(com.patric.mcexp.hideseek.util.Location pos) {
        this.lobbyPosition = pos;
    }

    public void setSeekerLobby(com.patric.mcexp.hideseek.util.Location pos) {
    ...
    @NotNull
    public com.patric.mcexp.hideseek.util.Location getGameSpawn() {
        if(mapSaveEnabled) {
    ...
    @NotNull
    public com.patric.mcexp.hideseek.util.Location getSpawn() {
        return spawnPosition;
    }
    ...
    @NotNull
    public com.patric.mcexp.hideseek.util.Location getLobby() {
    ...
    @NotNull
    public com.patric.mcexp.hideseek.util.Location getSeekerLobby() {
