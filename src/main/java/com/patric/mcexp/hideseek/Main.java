package com.patric.mcexp.hideseek;

import com.patric.mcexp.hideseek.command.*;
import com.patric.mcexp.hideseek.command.map.Debug;
import com.patric.mcexp.hideseek.command.map.GoTo;
import com.patric.mcexp.hideseek.command.map.Save;
import com.patric.mcexp.hideseek.command.map.blockhunt.blocks.Add;
import com.patric.mcexp.hideseek.command.map.blockhunt.blocks.List;
import com.patric.mcexp.hideseek.command.map.blockhunt.blocks.Remove;
import com.patric.mcexp.hideseek.command.map.set.*;
import com.patric.mcexp.hideseek.configuration.*;
import com.patric.mcexp.hideseek.game.*;
import com.patric.mcexp.hideseek.game.listener.*;
import com.patric.mcexp.hideseek.game.util.Status;
import com.patric.mcexp.hideseek.util.PAPIExpansion;
import com.patric.mcexp.hideseek.command.map.blockhunt.Enabled;
import com.patric.mcexp.hideseek.command.world.Create;
import com.patric.mcexp.hideseek.command.world.Delete;
import com.patric.mcexp.hideseek.command.world.Tp;
import com.patric.mcexp.hideseek.database.Database;
import com.patric.mcexp.hideseek.command.util.CommandGroup;
		...
		this.commandGroup = new CommandGroup("hs",
				...
				new CommandGroup("map",
						...
						new CommandGroup("unset",
								new com.patric.mcexp.hideseek.command.map.unset.Border()
						),
						new com.patric.mcexp.hideseek.command.map.Add(),
						new com.patric.mcexp.hideseek.command.map.Remove(),
						new com.patric.mcexp.hideseek.command.map.List(),
						new com.patric.mcexp.hideseek.command.map.Status(),
						new Save(),
						new Debug(),
						new GoTo()
				),
				new CommandGroup("world",
					new Create(),
					new Delete(),
					new com.patric.mcexp.hideseek.command.world.List(),
					new Tp()
				),
				new SetExitLocation(),
				new Top(),
