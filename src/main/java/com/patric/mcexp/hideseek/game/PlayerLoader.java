...
import static com.patric.mcexp.hideseek.configuration.Items.HIDER_ITEMS;
import static com.patric.mcexp.hideseek.configuration.Items.SEEKER_ITEMS;
...
public class PlayerLoader {
    ...
    public static void loadSpectator(Player player, Map map){
        ...
        Main.getInstance().getBoard().getPlayers().forEach(otherPlayer -> otherPlayer.hidePlayer(Main.getInstance(), player));
    ...
    public static void unloadPlayer(Player player){
        ...
        Main.getInstance().getBoard().getPlayers().forEach(temp -> {
            player.showPlayer(Main.getInstance(), temp);
            temp.showPlayer(Main.getInstance(), player);
        });
