...
import static com.patric.mcexp.hideseek.configuration.Config.glowPowerupItem;
...
public class InteractHandler implements Listener {
    ...
    private static ItemStack getPageItem(int page) {
        ItemStack prevItem = new ItemStack(XMaterial.ENCHANTED_BOOK.get(), page + 1);
    ...
    private static ItemStack getSkull(Player player, List<String> lore){
        assert XMaterial.PLAYER_HEAD.get() != null;
        ItemStack playerHead = new ItemStack(XMaterial.PLAYER_HEAD.get(), 1);
